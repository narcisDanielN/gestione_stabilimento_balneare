...
{
	\begin{enumerate}[nosep, leftmargin=29px]
...
}
{
	...
	\begin{enumerate}[leftmargin=*]
		\item[•] \textbf{Testing}: le classi che si occupano dei test sono \hyperref[itm:application_user]{\texttt{ManageUserServiceTest}}, \hyperref[itm:application_user]{\texttt{ManageCustomerServiceTest}}, \hyperref[itm:application_user]{\texttt{ManageOwnerServiceTest}} e \hyperref[itm:application_user]{\texttt{ManageAdminServiceTest}} nel package \texttt{service}; \hyperref[itm:domain_user]{\texttt{UserTest}}, \hyperref[itm:domain_user]{\texttt{CustomerTest}}, \hyperref[itm:domain_user]{\texttt{OwnerTest}} e \hyperref[itm:domain_user]{\texttt{AdminTest}} nel package \texttt{domain}. \newline Vengono usate anche \hyperref[itm:application_common]{\texttt{service.AddressServiceTest}} e \hyperref[itm:domain_beachsubclasses]{\texttt{domain.AddressTest}} in caso di un \texttt{Customer} che decide di modificare l'indirizzo.
	\end{enumerate}
}