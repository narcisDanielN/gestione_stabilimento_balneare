...
}
{
	...
	\begin{enumerate}[leftmargin=*]
		\item[•] \textbf{Mockup}: si veda \autoref{fig:mockup4} - Le Mie Prenotazioni e Recensioni
		
		\item[•] \textbf{Testing}: le classi che si occupano dei test sono \hyperref[itm:application_moderation]{\texttt{ReviewServiceTest}} nel package \texttt{service}; \hyperref[itm:domain_moderation]{\texttt{ReviewTest}} nel package \texttt{domain}.
	\end{enumerate}
}