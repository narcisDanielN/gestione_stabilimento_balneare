...
}
{
	...
	\begin{enumerate}[leftmargin=*]
		\item[•] \textbf{Testing}: le classi che si occupano dei test sono \hyperref[itm:application_beach]{\texttt{CreateBeachServiceTest}} e \hyperref[itm:application_common]{\texttt{AddressServiceTest}} nel package \texttt{service}, tutte le classi nei packages \hyperref[itm:domain_beach]{\texttt{domain.beach}} e \hyperref[itm:domain_beachsubclasses]{\texttt{domain.common}}.
	\end{enumerate}
}